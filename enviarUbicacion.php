...
$persona = $sentencia->fetch(PDO::FETCH_OBJ);
    ...
    $url = 'https://api.green-api.com/waInstance1101816218/sendLocation/c7a2b4c8f8824dedaa8bef6b6c16b4f925cf478c3c854f2da0';
    $data = [
        "chatId" => "51".$persona->celular."@c.us",
        "nameLocation"=> "Ubicacion Tienda",
        "address" =>"HFCJ+84H, José Luis Bustamante y Rivero 04009",
        "latitude"=> -16.429162022855394, 
        "longitude"=>-71.51964016494892
