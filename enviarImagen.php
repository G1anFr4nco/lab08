...
$persona = $sentencia->fetch(PDO::FETCH_OBJ);
    ...
    $data = [
        ...
        "urlFile"=> "https://media.informabtl.com/wp-content/uploads/2018/05/promociones-retail-e1525819399293-768x593.jpg",
        "fileName" =>"promos.jpg",
        "caption"=> "Aproveche las mejores promociones. No las dejes pasar, ahora es tu momento!"
